...
const SLOTS = [
  ...
  // Change interval shortens significantly with tune stage and ethanol content.
  {
    ...
    variants:[
      ...
      { id:"brisk_er12s", buyUrl:"https://www.034motorsport.com/brisk-er12s-silver-performance-spark-plug-priced-each.html",
      ...
      { id:"brisk_er10s", buyUrl:"https://www.034motorsport.com/brisk-er10s-silver-performance-spark-plug-priced-each.html",
  ...
  // NEVER use oil additives — Audi explicitly warns. Fine oil screen risk on 4.0T.
  {
    ...
    variants:[
      ...
      { id:"motul_xclean_5w40", buyUrl:"https://www.amazon.com/Motul-104720-X-Clean-5W-40-5-Liter/dp/B00EOMGDG4",
      ...
      { id:"mobil1_0w40", buyUrl:"https://www.amazon.com/Mobil-1-Synthetic-Motor-0W-40/dp/B07GMJQVGB",
      ...
      { id:"motul_xpower_10w60", buyUrl:"https://www.amazon.com/Motul-100272-Power-10W-60-Liter/dp/B00D9J32LM",
  ...
  // ── WASTEGATE ACTUATORS ───────────────────────────────────────────────
  {
    ...
    variants:[
      { id:"tgk_wg", buyUrl:"https://tgkmotorsport.com/products/tgk-60mm-wastegate-kit",   brand:"TGK Motorsport", label:"60mm Vacuum Wastegate Kit",  price:700, rating:5.0,
        hp:{a6_20t:0,a6_30t:0,a7_20t:0,a7_30t:0,s6:0,s7:0,a8:0,s8:0,rs6:0,rs7:0},
        torque:{a6_20t:0,a6_30t:0,a7_20t:0,a7_30t:0,s6:0,s7:0,a8:0,s8:0,rs6:0,rs7:0},
      ...
      { id:"tial_wg", buyUrl:"https://tialsport.com/product/mvi-series-actuator/",  brand:"Tial",           label:"MVI Wastegate Actuators",    price:750, rating:4.8,
        hp:{a6_20t:0,a6_30t:0,a7_20t:0,a7_30t:0,s6:0,s7:0,a8:0,s8:0,rs6:0,rs7:0},
        torque:{a6_20t:0,a6_30t:0,a7_20t:0,a7_30t:0,s6:0,s7:0,a8:0,s8:0,rs6:0,rs7:0},
      ...
      { id:"srm_wg", buyUrl:"https://sillyrabbitmotorsport.com/srm850-single-turbo-kit.html",   brand:"SRM",            label:"High Vacuum Upgraded Actuators", price:650, rating:4.8,
        hp:{a6_20t:0,a6_30t:0,a7_20t:0,a7_30t:0,s6:0,s7:0,a8:0,s8:0,rs6:0,rs7:0},
        torque:{a6_20t:0,a6_30t:0,a7_20t:0,a7_30t:0,s6:0,s7:0,a8:0,s8:0,rs6:0,rs7:0},
  ...
  },
  {
    ...
    variants:[
      ...
      { id:"xona_5657", buyUrl:"https://xonarotor.com/products/xona-rotor-57-57s-ball-bearing-turbocharger", brand:"Xona Rotor", label:"XR5657S (King)",        price:3600, rating:5.0,
      ...
      { id:"xona_6564", buyUrl:"https://xonarotor.com/products/xona-rotor-65-64s-ball-bearing-turbocharger", brand:"Xona Rotor", label:"XR6564S (Big Frame)",   price:4200, rating:4.9,
      ...
      { id:"g40_1150", buyUrl:"https://www.atpturbo.com/mm5/merchant.mvc?Screen=PROD&Store_Code=tp&Product_Code=GRT-TBO-G40",   brand:"Garrett",    label:"G40-1150 Single",       price:3400, rating:4.7,
      ...
      { id:"g45_1500", buyUrl:"https://www.atpturbo.com/mm5/merchant.mvc?Screen=PROD&Store_Code=tp&Product_Code=GRT-TBO-G45",   brand:"Garrett",    label:"G45-1500 Single",       price:3900, rating:4.8,
  ...
  // ── FUELING ───────────────────────────────────────────────────────────
  {
    ...
    variants:[
      { id:"autotech_hpfp", buyUrl:"https://autotechperformance.com/product-category/audi/audi-c7-s6-s7-rs7/", brand:"Autotech", label:"Dual HPFP Upgrade Kit",   price:520, rating:5.0,
      ...
      { id:"034_hpfp", buyUrl:"https://www.034motorsport.com/high-pressure-fuel-pump-piston-upgrade-kit-for-audi-c7-c7-5-s6-s7.html",      brand:"034 Motorsport", label:"HPFP Piston Upgrade Kit", price:480, rating:4.9,
        hp:{a6_20t:5,a6_30t:5,a7_20t:5,a7_30t:5,s6:8,s7:8,a8:8,s8:9,rs6:10,rs7:10},
      ...
      { id:"loba_hpfp", buyUrl:"https://www.urotuning.com/products/loba-hpfp-upgrade-4-0-tfsi",    brand:"Loba",         label:"600cc HPFP",               price:475, rating:4.7,
        hp:{a6_20t:5,a6_30t:5,a7_20t:5,a7_30t:5,s6:8,s7:8,a8:8,s8:9,rs6:10,rs7:10},
  ...
  // ── INTAKE ────────────────────────────────────────────────────────────
  {
    ...
    variants:[
      ...
      { id:"eventuri", buyUrl:"https://eventuri.net/product/audi-s6-s7-rs6-rs7-4-0t-carbon-intake/",  brand:"Eventuri",  label:"Carbon Intake System",  price:899, rating:4.9,
      ...
      { id:"tgk_4in", buyUrl:"https://tgkmotorsport.com/products/tgk-4-inch-intake",   brand:"TGK Motorsport", label:"4\" Merged Inlet Intake", price:399, rating:4.9,
      ...
      { id:"tgk_5in", buyUrl:"https://tgkmotorsport.com/products/tgk-5-inch-intake-kit",   brand:"TGK Motorsport", label:"5\" Conversion Kit (1000+HP)", price:499, rating:4.8,
      ...
      { id:"srm_intake", buyUrl:"https://sillyrabbitmotorsport.com/luftwaffe-intake-c7-4-0t.html", brand:"SRM", label:"2.5\" Luftwaffe Intake (C7)",      price:595, rating:4.8,
      ...
      { id:"srm_s8_intake", buyUrl:"https://sillyrabbitmotorsport.com/luftwaffe-intake-d4-s8-4-0t.html", brand:"SRM", label:"3\" Dual Intake (S8 / D4)",     price:895, rating:4.8,
        hp:{a6_20t:0,a6_30t:0,a7_20t:0,a7_30t:0,s6:0,s7:0,a8:0,s8:0,rs6:0,rs7:0},
        torque:{a6_20t:0,a6_30t:0,a7_20t:0,a7_30t:0,s6:0,s7:0,a8:0,s8:0,rs6:0,rs7:0},
  ...
  // ── BOV / DIVERTER VALVE ─────────────────────────────────────────────
  {
    ...
    variants:[
      { id:"tgk_bov", buyUrl:"https://tgkmotorsport.com/products/tgk-motorsport-blow-off-valve-bov-conversion-kit-for-audi-4-0t",   brand:"TGK Motorsport", label:"BOV Conversion Kit",   price:700, rating:5.0,
        hp:{a6_20t:0,a6_30t:0,a7_20t:0,a7_30t:0,s6:0,s7:0,a8:0,s8:0,rs6:0,rs7:0},
        torque:{a6_20t:0,a6_30t:0,a7_20t:0,a7_30t:0,s6:0,s7:0,a8:0,s8:0,rs6:0,rs7:0},
      ...
      { id:"gfb_dv", buyUrl:"https://www.gfb.com.au/product/t9381-dv-for-audi-vw/",    brand:"GFB",            label:"DV+ Diverter Valve",   price:89,  rating:4.6,
        hp:{a6_20t:0,a6_30t:0,a7_20t:0,a7_30t:0,s6:0,s7:0,a8:0,s8:0,rs6:0,rs7:0},
        torque:{a6_20t:0,a6_30t:0,a7_20t:0,a7_30t:0,s6:0,s7:0,a8:0,s8:0,rs6:0,rs7:0},
  ...
  // ── EXHAUST ───────────────────────────────────────────────────────────
  {
    ...
    variants:[
      ...
      { id:"milltek_dp", buyUrl:"https://www.milltekcorp.com/large-bore-downpipe-hi-flow-sports-cat-for-products-audi-rs6-c7-4.0-tfsi-biturbo-quattro-inc-perform/p3051", brand:"Milltek",  label:"Sport HFC DP",       price:895, rating:4.7,
      ...
      { id:"ie_dp", buyUrl:"https://performancebyie.com/collections/downpipes",      brand:"IE",       label:"Race Catless DP",    price:749, rating:4.8,
  ...
  // ── SUSPENSION ────────────────────────────────────────────────────────
  {
    ...
    variants:[
      { id:"kw_v3", buyUrl:"https://www.kwsuspensions.com/",      brand:"KW",       label:"Variant 3",      price:2249, rating:4.9,
        hp:{a6_20t:0,a6_30t:0,a7_20t:0,a7_30t:0,s6:0,s7:0,a8:0,s8:0,rs6:0,rs7:0},
        torque:{a6_20t:0,a6_30t:0,a7_20t:0,a7_30t:0,s6:0,s7:0,a8:0,s8:0,rs6:0,rs7:0},
  ...
  },
  {
    ...
    variants:[
      { id:"stoptech_bbk", buyUrl:"https://www.stoptech.com/big-brake-kits/",brand:"StopTech",  label:"Trophy Sport 380", price:2999, rating:4.8,
        hp:{a6_20t:0,a6_30t:0,a7_20t:0,a7_30t:0,s6:0,s7:0,a8:0,s8:0,rs6:0,rs7:0},
        torque:{a6_20t:0,a6_30t:0,a7_20t:0,a7_30t:0,s6:0,s7:0,a8:0,s8:0,rs6:0,rs7:0},
  ...
  // ── EXHAUST (expanded brands) ─────────────────────────────────────────
  {
    ...
    variants:[
      ...
      { id:"remus_sport", buyUrl:"https://remus.eu/en/sport-exhaust-audi-rs6-rs7-incl-ec-type-approval-046520-0500lr",   brand:"Remus",      label:"Sport Cat-Back",           price:1650, rating:4.6,
        hp:{a6_20t:5,a6_30t:5,a7_20t:5,a7_30t:5,s6:8,s7:8,a8:8,s8:9,rs6:10,rs7:10},
        torque:{a6_20t:5,a6_30t:5,a7_20t:5,a7_30t:5,s6:8,s7:8,a8:8,s8:9,rs6:10,rs7:10},
      ...
      { id:"capristo", buyUrl:"https://capristoexhaust.com/product/s6-s7-valved-exhaust/",      brand:"Capristo",   label:"Valved Exhaust System",    price:3200, rating:4.8,
        hp:{a6_20t:7,a6_30t:6,a7_20t:7,a7_30t:6,s6:11,s7:11,a8:11,s8:12,rs6:13,rs7:13},
        torque:{a6_20t:6,a6_30t:5,a7_20t:6,a7_30t:5,s6:10,s7:10,a8:10,s8:11,rs6:12,rs7:12},
